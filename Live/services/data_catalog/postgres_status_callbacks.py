...
def register_postgres_status_callbacks(app):
    if getattr(app, "_v24_1_postgres_status_callbacks_registered", False):
        return
    ...
    def _v24_1_postgres_status(check_clicks, ingest_clicks, max_json_bytes, max_csv_rows):
        triggered = ""
        try:
        ...
        if triggered == "data-library-pg-ingest-btn":
        ...
        status = get_postgres_status(repo_root=repo, migrate=True)
        return (
    ...
    app._v24_1_postgres_status_callbacks_registered = True
