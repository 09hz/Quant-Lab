...
def main() -> int:
    ...
    symbol_id_match = re.search(r'_V23_2_2_1_MEMORY_SYMBOL_INPUT_ID\s*=\s*["\']([^"\']+)["\']', callbacks_text)
    if not symbol_id_match:
        print("Could not find v23.2.2.1 callback symbol input ID marker.")
        return 5
    ...
    print("v23.2.2.1 Market Memory Panel Repair self-test: PASS")
